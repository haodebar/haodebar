package com.chaoyue.haodebar.exception;
...
public class ControllerAdvice {
    ...
    public Result handlerException(Exception exception, HttpServletRequest request) {
        ...
        Result result = Result.createFail(ResultCodeEnum.ERROR.getCode(), errorSystem + exception.toString());
        return result;
    }
    ...
    public Result handlerSpringAOPException(Exception exception) {
        Result result = Result.createFail(ResultCodeEnum.ILLEGAL_REQUEST.getCode(), errorSystem + exception.getMessage());
        return result;
    }
    ...
    public Result handlerSpringAOPException(MethodArgumentTypeMismatchException exception) {
        Result result = Result.createFail(ResultCodeEnum.PARAM_TYPE_MISMATCH.getCode(), errorSystem + exception.getMessage());
        return result;
    }
    ...
    public Result handlerMethodArgumentNotValidException(MethodArgumentNotValidException methodArgumentNotValidException) {
        ...
        Result result = Result.createFail(ResultCodeEnum.PARAM_VALID_ERROR.getCode(), errorSystem + errorMessage);
        return result;
    }
    ...
    public Result handlerCustomException(BusinessException exception) {
        ...
        Result result = Result.createFail(exception.getCode(), errorSystem + errorMessage);
        return result;
    }
